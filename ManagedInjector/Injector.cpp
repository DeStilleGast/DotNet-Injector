...
static unsigned int WM_GOBABYGO = ::RegisterWindowMessage(L"Injector_DSG_MoveOn!");
...
#if _WIN64
	HINSTANCE hinstDLL = ::LoadLibrary((LPCTSTR)_T("ManagedInjector64.dll"));
#else
	HINSTANCE hinstDLL = ::LoadLibrary((LPCTSTR)_T("ManagedInjector32.dll"));
#endif // _WIN64
